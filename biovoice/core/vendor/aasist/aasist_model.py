...
Vendored from: https://github.com/clovaai/aasist
Copyright (c) 2021-present NAVER Corp.
MIT license

This file is self-contained: all helper classes are defined here.
"""
...
# Expected input length: 64600 samples (~4.04 sec at 16 kHz)
AASIST_INPUT_LEN = 64600
...
class CONV(nn.Module):
    """Sinc-conv front-end (learnable bandpass filterbank on raw waveform)."""
    ...
    def __init__(self, out_channels, kernel_size, sample_rate=16000,
        ...
        for i in range(len(self.mel) - 1):
            ...
            self.band_pass[i, :] = Tensor(
                np.hamming(self.kernel_size)) * Tensor(hideal)
...
class AASISTModel(nn.Module):
    """AASIST: Audio Anti-Spoofing using Integrated Spectro-Temporal GAT.
    ...
    def __init__(self, d_args=None):
        ...
        self.conv_time = CONV(
            out_channels=filts[0], kernel_size=d_args["first_conv"],
            in_channels=1)
